...
function initMap() {
    ...
    const lat = parseFloat(mapEl.dataset.lat || '39.7897668');
    const lng = parseFloat(mapEl.dataset.lng || '-104.8653014');
    ...
    if (typeof google !== 'undefined' && google.maps) {
        ...
        new google.maps.Marker({ position: center, map, title: 'Ludvik Electric' });
    } else {
        // Fallback
        mapEl.innerHTML =
...
console.log('✅ Ludvik Electric website loaded successfully!');